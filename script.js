...
function showMore() {
    ...
    var newLi_7 = document.createElement('li');
    var newLi_8 = document.createElement('li');
    var newLi_9 = document.createElement('li');
    var newPads = document.getElementsByClassName('sevenNine-flex');
    var newItems = newPads[0].childNodes;
    PaD.push(newItems[0], newItems[1], newItems[2]);
    newLi_7.className = 'pad-of-drop';
    newLi_8.className = 'pad-of-drop';
    newLi_9.className = 'pad-of-drop';
    newLi_7.innerHTML = +dropBoxOne.childNodes[13].textContent + 1;
    newLi_8.innerHTML = +dropBoxOne.childNodes[13].textContent + 2;
    newLi_9.innerHTML = +dropBoxOne.childNodes[13].textContent + 3;
    dropBoxOne.appendChild(newLi_7);
    dropBoxOne.appendChild(newLi_8);
    dropBoxOne.appendChild(newLi_9);
    newLi_7.onclick = selection();
    newLi_8.onclick = selection();
    newLi_9.onclick = selection();
}
